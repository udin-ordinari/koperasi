...
|
*/
$config['base_url'] = "https://" . $_SERVER['SERVER_NAME'] . str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
...
|
*/
$config['encryption_key'] = 'IlddJcH9abk1HsGIritjOJVDYLEpwvNh';
...
$config['csrf_token_name'] = 'app_token';
