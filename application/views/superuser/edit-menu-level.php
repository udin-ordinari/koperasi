	...
	<div class="col-lg-12 mx-auto">
		<div class="card">
			<div class="card-body p-4">
				...
				<input type="hidden" class="form-control" name="uid" id="uid" value="<?php echo $hasil->id; ?>">
				<div class="row mb-3">
					...
					<div class="col-sm-9">
						<select class="form-control select2" id="level" name="level">
							<option value="<?php echo $hasil->level_id; ?>"><?php echo get_level($hasil->level_id)->nama; ?></option>
							<option value="">============</option>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
						<select class="form-control select2" id="modul" name="modul">
							<option value="<?php echo $hasil->module_id; ?>"><?php echo get_modules($hasil->module_id)->module_name; ?></option>
							<option value="">============</option>
...
$('form').on('submit',function(e){
	...
	$.ajax({
        	type: "POST",
        	url: "<?php echo base_url('superuser/proses_edit_menu_level'); ?>",
        	data: form.serialize(),
