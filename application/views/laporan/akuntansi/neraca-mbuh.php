...
?>
									<tr>
										...
										<td class="text-right">Rp. a</td>
										<td class="text-right">Rp. b</td>
									</tr>
<?php } else { } ?>
									<?php } ?>
...
<?php $kewajibanlancar = $this->db->where('jenis', '4')->where('tampil', 'Iya')->get('app_akun'); $no = 1; foreach($kewajibanlancar->result() as $r) { ?>
									<tr>
										<td class="text-right"><?php echo $no++; ?> .</td>
...
<?php } ?>
							...
							<table class="table text-nowrap text-md-nowrap table-hover mg-b-0 tx-14">
								...
								<tbody>
<?php $kewajibanpanjang = $this->db->where('jenis', '5')->where('tampil', 'Iya')->get('app_akun'); $no = 1; foreach($kewajibanpanjang->result() as $ro) { ?>
									<tr>
										<td class="text-right"><?php echo $no++; ?> .</td>
...
<?php } ?>
							...
							<table class="table text-nowrap text-md-nowrap table-hover mg-b-0 tx-14">
								...
								<tbody>
<?php $equitas = $this->db->where('jenis', '6')->where('tampil', 'Iya')->get('app_akun'); $no = 1; foreach($equitas->result() as $ros) { ?>
									<tr>
										<td class="text-right"><?php echo $no++; ?> .</td>
