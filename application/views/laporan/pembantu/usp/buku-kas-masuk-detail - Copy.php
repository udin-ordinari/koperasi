			...
			<table class="table table-bordered mb-0 fs-7">
				<thead class="table-info">
					<tr class="text-center">
						<th colspan="7"> <?php echo $page; ?> </th>
					</tr>
					<tr class="kandel table text-capitalize">
						<td class="text-end" colspan="6">Periode : </td>
					...
					<tr class="table">
						...
						<td></td>
						<td><==</td>
						<td>Jasa dari pemotongan gaji</td>
						<td>Rp. </td>
						<td>Rp. </td>
					</tr>
					<tr class="table">
					...
					<tr class="table">
						<td></td>
						<td></td>
						<td class="bg-dark text-white">Rp. </td>
						<td></td>
						<td></td>
						<td>Rp. </td>
						<td class="bg-danger text-white">Rp. </td>
					</tr>
					<tr class="table">
					...
					<tr class="table">
						<td>Disetorkan Ke Induk Koperasi</td>
						<td class="text-center">:</td>
						<td>Rp. </td>
						<td></td>
						<td></td>
					...
					<tr class="table-secondary text-capitalize">
				...
				<tfoot>
					<tr>
						<td colspan="4"></td>
						<td class="kandel">Jumlah</td>
						<td class="kandel">Rp. 2</td>
						<td class="kandel">Rp. 3</td>
					</tr>
				</tfoot>		
			</table>
		</div>
