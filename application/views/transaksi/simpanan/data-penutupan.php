		...
		<div class="container-fluid">
			<div class="row">
						...
						<div class="page-title-right">
								...
								<button type="button" class="btn btn-success btn-icon-text my-2 me-2 rodo-melengkung" onclick="location.href='<?php echo base_url("transaksi/simpanan/penutupan");?>'">
			...
			<div class="card">
				<div class="card-body">
					<div class="table-responsive">
						<table class="table table-bordered border-bottom align-middle" id="penutupan">
...
$(document).ready(function() {
	var table = $('#penutupan').DataTable( {
		...
		ordering: true,
		order: [],
		ajax: "<?php echo base_url('transaksi/simpanan/get_data_penutupan');?>",
	});
} );
function Reload()
{
