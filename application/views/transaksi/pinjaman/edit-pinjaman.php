				...
				<div class="card p-1">
					<div class="card-body">
						...
						<div class="col-md-3 mb-2">
							...
							<input type="date" class="form-control" id="tgl_trans" name="tgl_trans" value="<?php echo $pengajuan->tgl; ?>">
						</div>
						<div class="col-md-3">
							...
							<div class="border border-3 p-2 rounded">
								<div class="row g-3">
									<div class="col-md-4">
										...
										<?php echo form_dropdown('jns_pinj', $jns_drop, $pengajuan->jns_pinj, 'class="form-control select2-show-search select2-dropdown" id="jns_pinj"');?> 
									</div>
									<div class="col-md-2">
	...
	Swal.fire({
		...
		if (result.isConfirmed) {
			...
			$.post("<?php echo base_url('transaksi/pinjaman/tolak');?>", values, function(response)
			{
				...
				{
					$("#PreviewModal").modal('hide');
					Lobibox.notify('info', {title: res.title, position: 'top right', icon: true, msg: res.message});
					setInterval(function()
					{
						location.reload();
					}, 2000);
