			...
			<form class="row g-3 pinjaman" id="form">
				...
				<input type="text" name="userid" id="userid" class="form-control sembunyi" burem readonly>
					<div class="col-md-3 ui-widget">
						...
						<input type="date" class="form-control" id="tgl_trans" name="tgl_trans" value="<?php echo $tahun - 1; ?>-12-30">
					</div>
					<div class="col-md-3">
									...
									<div class="row g-3">
										...
										<div class="col-md-6">
											<label for="input25" class="form-label">Keterangan</label>
										 	<div class="input-group">												
												<input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Bila Tidak Perlu Kosongi Saja.">
										 	</div>
										</div>
						  			</div>
								</div>
...
$(document).ready(function(){
	...
	$('#form').on('submit', function(e){  
		...
		$.ajax({  
			url:"<?php echo base_url('transaksi/pinjaman/add_piutang'); ?>",
                     	method:"POST",  
				...
				if(data.status == 'success')
				{
					...
					Swal.fire({
							...
							denyButtonText: "Tidak",
								...
								{
									window.location.href="<?php echo base_url('transaksi/pinjaman/piutang_lalu'); ?>";
								}
							});
