			...
			<form class="row g-3 pinjaman" id="form">
				...
				<input type="text" name="userid" id="userid" class="form-control sembunyi" burem readonly>
					<div class="col-md-3 ui-widget">
						...
						<input type="date" class="form-control" id="tgl_trans" name="tgl_trans" value="<?php echo $tahun;?>-12-30">
					</div>
					<div class="col-md-3">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="border border-3 p-4 rounded">
									<div class="row g-3">
										<div class="col-md-6">
											<label for="jns_pinj" class="form-label">Pokok Terbayar</label>
										...
										<div class="col-md-6">
											<label for="input25" class="form-label">Bunga Terbayar</label>
										 	<div class="input-group">
												<span class="input-group-text"><i class="fa-solid fa-rupiah-sign"></i></span>
							...
							<div class="col-lg-6">
								<div class="border border-3 p-4 rounded">
									<div class="row g-3">
										<div class="col-md-6">
											<label for="input25" class="form-label">Pokok Belum Terbayar</label>
										 	<div class="input-group">
												<span class="input-group-text"><i class="fa-solid fa-rupiah-sign"></i></span>
												<input type="text" class="form-control uang" id="pokok_belum" name="pokok_belum" placeholder="1.000.000">
										 	</div>
										</div>	
										<div class="col-md-6">
											<label for="input25" class="form-label">Bunga Belum Terbayar</label>
										 	<div class="input-group">
												<span class="input-group-text"><i class="fa-solid fa-rupiah-sign"></i></span>
												<input type="text" class="form-control uang" id="bunga_belum" name="bunga_belum" placeholder="1.000.000">
										 	</div>
										</div>
						  			</div>
								</div>
							...
							<div class="col-lg-12 mt-2">
								<div class="border border-3 p-4 rounded">
									<div class="row g-3">
										<div class="col-md-6">
											<label for="jns_pinj" class="form-label">Angsuran Perbulan</label>
										 	<div class="input-group">
												<span class="input-group-text"><i class="fa-solid fa-rupiah-sign"></i></span>
												<input type="text" class="form-control uang" id="angs" name="angs" placeholder="1.000.000">
										 	</div>
										</div>
										<div class="col-md-6">
											<label for="input25" class="form-label">Bunga Perbulan</label>
										 	<div class="input-group">
												<span class="input-group-text"><i class="fa-solid fa-rupiah-sign"></i></span>
												<input type="text" class="form-control uang" id="jasa" name="jasa" placeholder="1.000.000">
										 	</div>
										</div>										
                                    					</div>
								</div>
...
$(document).ready(function(){
	...
	$('#form').on('submit', function(e){  
		...
		$.ajax({  
			url:"<?php echo base_url('transaksi/pinjaman/add_saldo_awal_pinjaman'); ?>",
                     	method:"POST",  
