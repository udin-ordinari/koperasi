		...
		<div class="card custom-card">
			<div class="card-body row p-1">			
				<div class="col-md-3 mb-2">
					<label for="tgl" class="form-label mg-b-10">Tanggal</label>
					<input type="date" class="form-control" id="tgl" name="tgl">
				</div>
				<div class="col-md-6 mb-2">
					<label for="nik" class="form-label mg-b-10">Pilih Akun</label>
					<?php echo form_dropdown('akun', $this->sistem->selectdropdown('app_akun'), set_value('akun'), 'class="form-control select2" id="akun"'); ?>
				</div>
				<div class="col-md-3 mb-2">
					<label for="input2" class="form-label mg-b-10">Posisi</label>
				...
				<div class="col-md-5 mb-2">
					<label for="input2" class="form-label mg-b-10">Unit Kerja</label>
				...
				<div class="col-md-7 mb-2">
					<div class="form-group">
    						<label class="form-label mg-b-10">Upload Bukti</label>
    						<div class="input-group file-browser">
      							<input type="text" class="form-control border-end-0 browse-file" id="bukti_text" name="bukti" readonly>
				...
				<div class="col-md-4">
					<label for="input4" class="form-label mg-b-10">Jumlah</label>
				...
				<div class="col-md-4">
					<label for="input4" class="form-label mg-b-10">Pokok</label>
					<div class="input-group">
						<span class="input-group-text"><i class="fa-solid fa-rupiah-sign"></i></span>
				...
				<div class="col-md-4">
					<label for="input4" class="form-label mg-b-10">Profit</label>
					<div class="input-group">
						<span class="input-group-text"><i class="fa-solid fa-rupiah-sign"></i></span>
				...
				<div class="col-md-12">
					<label for="input3" class="form-label mg-b-10">Keterangan</label>
					<textarea class="form-control" id="keterangan" name="keterangan"></textarea>
				</div>
<div class="col-md-12">
  <img id="myimage" width="300" />
</div>
			</div>
...
$(document).ready(function(){
  ...
  // On file selection, display the image preview
  ...
  $(document).on('change', ':file', function() {
    ...
    var inputField = input.parents('.input-group').find(':text');
