...
(function(t, e) {
	...
	var e, a, n, i, o, s = "\n\nVisit documentation page to learn more: https://notiflix.github.io/documentation",
		r = "-apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif",
		l = {
			Success: "Success",
			Failure: "Failure",
			Warning: "Warning",
		...
		E = function(a, n, o, s) {
			...
			if(e.showOnlyTheLastOne && 0 < F)
				for(var A, M = t.document.querySelectorAll("[id^=" + e.ID + "-]:not([id=" + e.ID + "-" + F + "])"), X = 0; X < M.length; X++) A = M[X], null !== A.parentNode && A.parentNode.removeChild(A);
			e = v(!0, e, m)
		},
		O = function() {
			return null
		...
		j = function(e, a, i, o, s, l, c, m, p) {
			...
			if(e === d.Ask || e === d.Prompt) {
				w = o || "";
				var z = e === d.Ask ? Math.ceil(1.5 * w.length) : 200 < w.length ? Math.ceil(1.5 * w.length) : 250,
		...
		V = function(e, a, n, o, s) {
			...
			if("string" == typeof a && 0 < a.length && (m = a), o) {
				...
				var p = "";
				0 < m.length && (p = "<p id=\"" + i.messageID + "\" class=\"nx-loading-message\" style=\"color: #ffffff!important;font-size:" + i.messageFontSize + ";\">" + m + "</p>"), i.cssAnimation || (i.cssAnimationDuration = 0);
				var d = "";
				...
				var f = parseInt((i.svgSize || "").replace(/[^0-9]/g, "")),
					u = t.innerWidth,
					b = f >= u ? u - 40 + "px" : f + "px",
					h = "<div style=\"width:" + b + "; height:" + b + ";\" class=\"" + i.className + "-icon" + (0 < m.length ? " nx-with-message" : "") + "\">" + d + "</div>",
		...
		Q = function(e, a, n, i, s, l) {
			...
			if(e) {
				for(var S, L = ["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr", "html", "head", "title", "script", "style", "iframe"], D = 0; D < C; D++)
					if(S = c[D], S) {
						...
						if(1 > T.length) {
							...
							var E = "<span class=\"" + g + "-icon\" style=\"width:" + o.svgSize + ";height:" + o.svgSize + ";\">" + F + "</span>",
								O = "";
							...
							var W = t.getComputedStyle(S).getPropertyValue("position"),
								j = "string" == typeof W ? W.toLocaleLowerCase("en") : "relative",
							...
							var Q = "",
								K = -1 >= ["absolute", "relative", "fixed", "sticky"].indexOf(j);
							if(K || 0 < q.length) {
								if(!k("head")) return !1;
								K && (Q = "position:relative!important;");
								var J = "<style id=\"Style-" + b.ID + "-" + U + "\">" + Y + "." + z + "{" + Q + q + "}</style>",
				...
				tt = function(t) {
					if(t && 0 < t.length)
						for(var e, a = 0; a < t.length; a++) e = t[a], e && (e.classList.add("nx-remove"), _(e));
